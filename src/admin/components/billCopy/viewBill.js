...
export class billlCopy extends Component {
    ...
    componentDidMount() {
        axios.get('http://billing-software.dkdeepak.com/api/ViewBillCopy.php/?id=' + this.props.match.params.billNo)
            .then((response) => {
    ...
    downloadPDF = () => {
        axios.get('http://billing-software.dkdeepak.com/api/mailBill.php/?billNo=' + this.state.billNo + "&user=" + 1 + '&download=1')
            .then(response => {
    ...
    mail = () => {
        ...
        axios.get('http://billing-software.dkdeepak.com/api/mailBill.php/?billNo=' + this.state.billNo + "&user=" + 1 + "&mail=1").
            then((response) => {
            ...
            <div className='edit_bill_container'>
                <div className='edit_bill_head'>
                    <div className="edit_bill_head_left">
                        ...
                        <div className='bill_style_row'>
                            <h4 style={{ padding: "2% 0%", color: "rgba(34, 34, 34, 0.815)" }}>Total : {this.state.pageTotal}</h4>
                        </div>
