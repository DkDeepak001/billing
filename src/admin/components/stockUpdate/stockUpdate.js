                            ...
                            {this.state.BranchArray.length === 0 ?
                                ...
                                (this.state.BranchArray.map((row, index) => (
                                    ...
                                    >
                                        ...
                                        <td >{this.state.getData.filter(x => (x.branchId === row.BrachId)).length} Bill</td>
                                        <td ><Link to={`/Admin/stockUpdate/${row.BrachId}`} ><button className='css-button-rounded--blue'>View Detail</button></Link></td>
