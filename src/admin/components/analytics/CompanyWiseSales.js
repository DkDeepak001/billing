...
export class CompanyWiseSales extends Component {
    ...
    componentDidMount() {
        axios.get('http://billing-software.dkdeepak.com/api/getBillCompanyWise.php/?company_name=' + this.props.match.params.company_name)
            .then((response) => {
        ...
        //last 3 month
        axios.get('http://billing-software.dkdeepak.com/api/getDateWiseCompanyBill.php/?today=' + 1 + '&company_name=' + this.props.match.params.company_name)
            .then((response) => {
        ...
        axios.get('http://billing-software.dkdeepak.com/api/getDateWiseCompanyBill.php/?week=' + 1 + '&company_name=' + this.props.match.params.company_name)
            .then((response) => {
        ...
        axios.get('http://billing-software.dkdeepak.com/api/getDateWiseCompanyBill.php/?month=' + 1 + '&company_name=' + this.props.match.params.company_name)
            .then((response) => {
                ...
                <div className='analytics_top'>
                    <div className='analytics_revenue'>
                        <div className='analytics_revenue_top' style={{ margin: "1.2%  0%" }}>
                            <h2>Revenue by {this.props.match.params.company_name}</h2>
                        </div>
                                ...
                                <tbody>
                                    {this.state.getData.length === 0?<td> No Data Found</td>:
                                        ...
                                        <tr>
                                            ...
                                            <td>{x.totalPrice}</td>
                                            <td>{x.time}</td>
                                            <td><Link to={`/Admin/billCopy/viewBill/${x.billNo}`}><button className='css-button-rounded--blue'>View Detail</button></Link></td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
